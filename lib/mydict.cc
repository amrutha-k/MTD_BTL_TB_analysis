...
namespace ROOT {
   ...
   static TGenericClassInfo *GenerateInitInstanceLocal(const ::ModuleEventClass*)
   {
      ...
      static ::ROOT::TGenericClassInfo 
         instance("ModuleEventClass", ::ModuleEventClass::Class_Version(), "AnalysisUtils.h", 68,
...
"./interface/Co60SpectrumAnalyzer_2Peaks.h",
"./interface/Na22SpectrumAnalyzerSingleBar_TOFHIR2.h",
"./interface/SetTDRStyle.h",
"./interface/AnalysisUtils.h",
"./interface/Na22SpectrumAnalyzerSingleBar.h",
"./interface/SiPM_HDR2.h",
"./interface/FitUtils.h",
"./interface/Na22SpectrumAnalyzer.h",
"./interface/Co60SpectrumAnalyzer.h",
"./interface/TOFHIRThresholdZero.h",
0
    };
    static const char* includePaths[] = {
"/usr/include/root",
"/afs/cern.ch/user/a/amkrishn/Amrutha/Lab5015Analysis/",
0
    };
